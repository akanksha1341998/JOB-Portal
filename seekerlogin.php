...
$result=mysqli_query($con,$sql);
	...
	{
		echo '<h1><center>WELCOME '.$Username.'!!!!<center><br><a href="userPortal.html">Continue</a></center></h1>';
	} 
		else
	{ 
		echo '<h1>Wrong password or username ..<a href="seekerlogin.html">Please try again</a></h1>';
	}
?>
	</fieldset>
	</div>
