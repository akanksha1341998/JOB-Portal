...
$con = mysqli_connect('localhost' , 'root' , '');
	...
	$Location=$_POST['location'];
     $sql= "INSERT INTO company(LoginId,Password,Email,Company,Location,Industry) VALUES ('$Login','$Password','$email','$Company','$Location','$Industry')"; 
	...
	{
		echo '<h1><center>You have successfully registered!!!!<br><a href="provider.html">Continue</a></center></h1>';
	} 
